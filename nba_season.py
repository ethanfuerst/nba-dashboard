...
class NBA_Season:
    def __init__(self, season=datetime.datetime.today().year - 1):
        ...
        self.reg_player_scoring['OPPOSING_TEAM'] = self.reg_player_scoring['MATCHUP'].str.split(' .* ',expand=True)[1]
        ...
        self.po_player_scoring['OPPOSING_TEAM'] = self.po_player_scoring['MATCHUP'].str.split(' .* ',expand=True)[1]
